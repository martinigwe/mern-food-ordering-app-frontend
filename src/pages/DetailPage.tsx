...
import type { MenuItem as MenuItemTypes } from "@/types";
...
const DetailPage = ()=> {
    ...
    const [cartItems, setCartitem] = useState<CartItem[]>(()=> {
        const stororedCartItems = sessionStorage.getItem(`cartItems-${restaurantId}`);
        return stororedCartItems? JSON.parse(stororedCartItems): [];
            ...
            <div className="grid md:grid-cols-[4fr_2fr] gap-5 md:px-32">
                ...
                <div>
                    <Card>
                        ...
                        <CardFooter><CheckOutButton onCheckout={onCheckout} disabled={cartItems.length === 0} isLoading={isCheckoutLoading}/></CardFooter>
                    </Card>
                </div>
            </div>

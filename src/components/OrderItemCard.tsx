...
const OrderItemCard = ({order}:Props) => {
    ...
    const [ststus, setStatus] = useState<OrderStatus>(order.status);
        ...
        <Card>
            ...
            <CardContent className="flex flex-col gap-6">
                ...
                <div className="flex flex-col space-y-1.5">
                    ...
                    <Select value={ststus} disabled={isLoading} onValueChange={(value)=> handleStatusChange(value as OrderStatus)}>
